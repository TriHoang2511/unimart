                ...
                <table class="table table-hover align-middle border">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>1</td>
                            <td>
                                <img src="https://via.placeholder.com/60x60" class="rounded border shadow-sm" alt="">
                            </td>
                            <td>
                                <a href="#" class="fw-bold text-decoration-none text-dark d-block">iPhone 15 Pro Max 256GB</a>
                            ...
                            <td><span class="badge bg-info-subtle text-info border border-info-subtle px-2">Điện thoại</span></td>
                            <td class="small">12/01/2026</td>
                            <td>
                                <span class="badge bg-success-subtle text-success border border-success-subtle p-1 px-2">
                                    <i class="fa fa-check-circle me-1"></i>Đang bán
                                </span>
                            </td>
                            <td>
                                <div class="btn-group">
                                    <a href="#" class="btn btn-sm btn-outline-success" title="Sửa"><i class="fa fa-edit"></i></a>
                                    <a href="#" class="btn btn-sm btn-outline-danger" title="Xóa"><i class="fa fa-trash"></i></a>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#" class="fw-bold text-decoration-none text-dark d-block">MacBook Air M2 8GB/256GB</a>
                                <div class="text-muted small">
                            ...
                            <td>
                                <span class="badge bg-danger-subtle text-danger border border-danger-subtle px-2">Hết hàng</span>
                            </td>
                            <td><span class="badge bg-info-subtle text-info border border-info-subtle px-2">Laptop</span></td>
                            <td class="small">10/01/2026</td>
                            <td>
                                <span class="badge bg-secondary-subtle text-secondary border border-secondary-subtle p-1 px-2">
                                    Tạm ngưng
                                </span>
                            </td>
                            <td>
                                <div class="btn-group">
                                    <a href="#" class="btn btn-sm btn-outline-success"><i class="fa fa-edit"></i></a>
...
<style>
    ...
    .analytic a { font-size: 14px; transition: all 0.3s; }
    .analytic a:hover { color: #0d6efd !important; }
    .table thead th { font-size: 12px; letter-spacing: 0.5px; }
    .img-thumbnail { object-fit: cover; }
    .filter-box { border: 1px solid #e3e6f0; }
</style>
